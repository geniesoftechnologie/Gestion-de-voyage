...
public class ReservationDao extends Dao <Reservation> {
    ...
    public Reservation rechercher(long id) {
        ...
        try {
            ...
            if(result.next() ){
                ...
                e.setOption(result.getString("opt"));
                e.setDater(result.getDate("dater"));
                e.setUserid(result.getInt("userid"));
            }
    ...
    public void inserer(Reservation r) {
       SimpleDateFormat amj = new SimpleDateFormat("yyyy-MM-dd");
        try {
            PreparedStatement prepare = this.connect.prepareStatement("INSERT INTO reservation( id_utilisateur, nom, prenom, passport, id_vol, nom_aeroport, datedepart, datearrivee, heurdepart, heurarrivee, nom_aeroport_ar, prix, dater, opt, userid, idf) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
            ...
            prepare.setString(14, r.getOption());
            prepare.setInt(15, r.getUserid());
            prepare.setInt(16, r.getIdf());
    ...
    public void modifier(Reservation r, long id) {
        SimpleDateFormat amj = new SimpleDateFormat("yyyy-MM-dd");
        try {
            PreparedStatement prepare = this.connect.prepareStatement("UPDATE reservation SET id_utilisateur = ?, nom = ?, prenom = ? , passport = ? ,id_vol = ?, nom_aeroport = ?, datedepart = ?, datearrivee = ?, heurdepart = ?, heurarrivee = ?, nom_aeroport_ar = ?, prix = ?, dater = ?, opt = ?, userid = ? WHERE id ="+id);
            prepare.setInt(1, r.getId_utilisateur());
            prepare.setString(2, r.getNom());
            prepare.setString(3, r.getPrenom());
            prepare.setString(4, r.getPassport());
    ...
    public List<Reservation> liste() {
        ...
        ResultSet result;
        try {
            result = this.connect.createStatement().executeQuery("SELECT * FROM reservation where opt = 'simple' or opt = 'promo'");
            while(result.next()){
    ...
    public List<Reservation> listesimplefiltre(int userid) {
        List<Reservation> r = new ArrayList();
        Reservation obj = new Reservation();
        ResultSet result;
        try {
            result = this.connect.createStatement().executeQuery("SELECT * FROM reservation where opt = 'simple' and userid ="+userid);
            while(result.next()){
            obj.setId(result.getInt("id"));
            obj.setId_utilisateur(result.getInt("id_utilisateur"));
            obj.setNom(result.getString("nom"));
    ...
    public List<Reservation> listepromofiltre(int userid) {
        List<Reservation> r = new ArrayList();
        Reservation obj = new Reservation();
        ResultSet result;
        try {
            result = this.connect.createStatement().executeQuery("SELECT * FROM reservation where opt = 'promo' and userid ="+userid);
            while(result.next()){
            obj.setId(result.getInt("id"));
            obj.setId_utilisateur(result.getInt("id_utilisateur"));
            obj.setNom(result.getString("nom"));
    ...
    public List<Reservation> listehadj() {
        List<Reservation> r = new ArrayList();
        Reservation obj = new Reservation();
        ResultSet result;
        try {
            result = this.connect.createStatement().executeQuery("SELECT * FROM reservation where opt = 'hadj'");
            while(result.next()){
            obj.setId(result.getInt("id"));
            obj.setId_utilisateur(result.getInt("id_utilisateur"));
            obj.setNom(result.getString("nom"));
    ...
    public List<Reservation> listehadjfiltre(int userid) {
        List<Reservation> r = new ArrayList();
        Reservation obj = new Reservation();
        ResultSet result;
        try {
            result = this.connect.createStatement().executeQuery("SELECT * FROM reservation where opt = 'hadj' and userid ="+userid);
            while(result.next()){
            obj.setId(result.getInt("id"));
            obj.setId_utilisateur(result.getInt("id_utilisateur"));
            obj.setNom(result.getString("nom"));
