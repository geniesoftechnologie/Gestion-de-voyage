 ...
 * @author bureau
 */
public class CompagnieForm extends javax.swing.JInternalFrame {

    /**
     * Creates new form CompagnieForm
     */
    public CompagnieForm() {
        initComponents();
    ...
    private void initComponents() {
        ...
        txt_libelle.setBackground(new java.awt.Color(204, 204, 204));
        txt_libelle.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        txt_libelle.setForeground(new java.awt.Color(0, 0, 204));
        txt_libelle.setBorder(javax.swing.BorderFactory.createEtchedBorder());
        ...
        btn_suppression.setBorder(null);
        ...
        btn_modification.setText("Edit");
        btn_modification.setBorder(null);
        ...
        btn_enregistrement.setBorder(null);
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/AirlineTailQuiz.jpg"))); // NOI18N

        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/AirlineTailQuiz.jpg"))); // NOI18N
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addComponent(txt_libelle, javax.swing.GroupLayout.PREFERRED_SIZE, 144, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        CompagnieDao vdao = new CompagnieDao();
        Compagnie v = vdao.rechercher(id);
        if(v!=null){

            txt_libelle.setText(v.getLibelle());
        }
    ...
    private void btn_suppressionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_suppressionActionPerformed
        ...
        if(index >= 0){
            ...
            cdao.supprimer(id);
            JOptionPane.showMessageDialog(null, "Compagnie supprimer...");
            vider();
            list_v();
        }
        else{
    ...
    private void btn_modificationActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_modificationActionPerformed
        ...
        int id = (int) jTable1.getValueAt(index, 0);
        CompagnieDao cdao = new CompagnieDao();
        String ville = txt_libelle.getText();
        if(ville.equals("")){
            JOptionPane.showMessageDialog(this, "Veuillez cliquer sur la ligne ou modifier...");
        }
        else {
            Compagnie v = new Compagnie(ville);
            cdao.modifier(v, id);
            JOptionPane.showMessageDialog(null, "Compagnie modifier...");
            vider();
            list_v();
        }
    ...
    private void btn_enregistrementActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_enregistrementActionPerformed
        ...
        if(ville.equals("")){
            ...
            CompagnieDao cdao = new CompagnieDao();
            cdao.inserer(v);
            JOptionPane.showMessageDialog(null, "Compagnie crée avec success...");
            vider();
            list_v();
        }
